        ...
        <div class="card" style="margin-left:20px; margin-right:20px; margin-bottom:20px;">
            ...
            <div class="card-block">
                <?php 
                    ...
                    $objParsez = oci_parse($objConnect, $sqls);
                    oci_execute ($objParsez,OCI_DEFAULT);
                ?>

                <table id="myTable" class="display" cellspacing="0" width="100%">
                    <br>
                    <thead>
                        <td width="100px"><center>รหัสพนักงาน</center></td>
                        <td width="35%"><center>ชื่อ</center></td>
                        <td width="30%"><center>นามสกุล</center></td>
                        <td>ดำเนินการ</td>
                    </thead>
                <?php
                    while($objResultt = oci_fetch_array($objParsez,OCI_BOTH))
                    {
                    ?>
                    <tr>
                        <td><div align="center"><?php echo $objResultt["ID_PERSONNEL"];?></td>
                        <td><div align="center"><?php echo $objResultt["NAME"];?></td>
                        <td><div align="center"><?php echo $objResultt["LASTNAME"];?></td>
                        <td>
