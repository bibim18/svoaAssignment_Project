            ...
            <div class="card-block">
                ...
                <table id="myTable" class="display" cellspacing="0" width="100%">
                    ...
                    <thead>
                        ...
                        <td width="77%"><center>ชื่อการอบรม</center></td>
                        <td>ดำเนินการ</td>
                    </thead>
                <?php
                    while($objResultz = oci_fetch_array($objParsez,OCI_BOTH))
                    {
                    ?>
                    <tr>
                        <td><div align="center"><?php echo $objResultz["ID_PERSONNEL"];?></td>
                        <td><div align="center"><?php echo $objResultz["NAME"];?></td>
                        <td>
