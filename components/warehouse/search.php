  ...
  <body>
    ...
    while($objResult = oci_fetch_array($objParse,OCI_BOTH)){
       ...
       <div class="row">
        ...
        <div class="col">
        <center>วันที่ :<input class="form-control" type="date" name="date" value="" required>
        </div>
      </div>
      <div class="row">
...
<div class="row">
  <div class="col-8"></div>
  <div class="col-4">ราคารวม : <input class="right" type=text name="gap" required></div>
</div>

<center>     <button class="btn btn-success" type="submit" name="button">บันทึกข้อมูล</button>
    </form>
  </body>
</html>
